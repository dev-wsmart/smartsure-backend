...
@section('title', 'ชีวิตดี๊ดีเมื่อมี SMART SURE - หน้าหลัก | Backend')
...
<div class="col-10 pt-4 px-5">
    <div class="row mb-3">
        <div class="col-12">
            <h1>หน้าหลัก | ชีวิตดี๊ดีเมื่อมี SMART SURE</h1>
        </div>
    </div>
    <div class="row p-3 box-content">
        <div class="col-12 mb-3 text-right">
            <a href="{{ route('add-content2.index') }}" class="btn btn-success">Add Content</a>
        </div>
        <div class="col-12">
